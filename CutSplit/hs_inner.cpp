...
hstrieInner::hstrieInner(int number, pc_rule* subset, int binth1, hs_node_t* node)
{
  gChildCount = 0;
  gNumTreeNode = 0;
  gNumLeafNode = 0;
 ...
 * =====================================================================================
 */
static inline int SegPointCompare (const void * a, const void * b)
{
 ...
 * =====================================================================================
 */
int hstrieInner::BuildHSTree (rule_set_t* ruleset, hs_node_t* currNode, unsigned int depth)
{
    /*Update Leaf node*/
	...
	// Check all rules and remove if the rule is already matched!
	for (num = 0; num < ruleset->num; num ++) {
